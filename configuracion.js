...
global.creadorname = "ᴊᴇsᴜs-ᴏғᴄ";
global.creatorname = "ᴊᴇsᴜs-ᴏғᴄ";
...
//------------- Sticker WM -----------
global.packname = `ᴊᴇsᴜs - ᴏғᴄ`;
global.author = `ɴɪɢʜᴛᴄᴏʀᴇ〔ʙᴏᴛ〕`;
//_______________
global.wm = "◈⏤͟͟͞͞ɴɪɢʜᴛᴄᴏʀᴇ ʙᴏᴛ ✧ ᴊᴇsᴜs - ᴏғᴄ⏤͟͟͞͞◈";
global.db3t = `ɴɪɢʜᴛᴄᴏʀᴇ〔ʙᴏᴛ〕`;
global.wm3 = db3t;
global.codex = `Jesus-ofc`;
